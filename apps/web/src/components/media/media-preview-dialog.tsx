...
import { Film, HardDrive, Clock, Video, Download, ExternalLink, AlertCircle, RotateCw } from "lucide-react";
                ...
                {videoError && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-6 bg-zinc-950/95 text-center text-white backdrop-blur-sm z-10">
                    ...
                    <h3 className="text-sm font-semibold text-zinc-100 mb-1">
                      Format / Codec Tidak Didukung Browser
                    </h3>
                    <p className="text-xs text-zinc-400 max-w-md mb-4 leading-relaxed">
                      Browser Anda tidak dapat memutar codec video ini secara langsung (misal: HEVC/H.265 atau audio khusus). Namun file video tetap utuh di server dan siap digunakan untuk live streaming.
                    </p>
